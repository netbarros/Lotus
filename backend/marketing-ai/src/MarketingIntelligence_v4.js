...
exports.MarketingIntelligence_v4 = void 0;
// ==================== MARKETING INTELLIGENCE CORE ====================
class MarketingIntelligence_v4 {
  redis;
  pool;
  sofia; // 🧠 Sofia AI - The Brain
  langfuse; // 📊 Observability
  qdrant; // 🔍 Vector Search
  isInitialized = false;
  constructor(redisClient, pgPool, sofiaService, langfuseService, qdrantService) {
  ...
  async sofiaGenerateAudience(objective) {
  ...
  async sofiaSelectChannels(objective, preferredChannels) {
  ...
  async sofiaGenerateKPIs(objective) {
  ...
  determineCampaignType(objective) {
  ...
  async getNextBestAction(leadId) {
  ...
  async predictEngagement(content, type) {
  ...
  async mapCustomerJourney(leadId) {
  ...
  async analyzeJourneyStages(lead) {
  ...
  async generateJourneyInsights(lead, stages) {
  ...
  async generateJourneyRecommendations(lead, stages) {
  ...
  async predictJourneyPath(lead, stages) {
  ...
  calculateTimeInStage(stages, currentStage) {
...
exports.MarketingIntelligence_v4 = MarketingIntelligence_v4;
exports.default = MarketingIntelligence_v4;
//# sourceMappingURL=MarketingIntelligence_v4.js.map
